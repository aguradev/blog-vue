<template>
    <div>
        ...
        <section class="reactive-lesson">
            ...
            <p>Merupakan property yang sama seperti ref namun hanya dapat menampung data tipe <code>object</code> dan
                berikut
            ...
            <div class="contact-number-section">
                ...
                <div>
                    ...
                    <p>Hello, my name is {{ contactReactive.name }} and this is my phone {{ contactReactive.phoneNumber }}
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="computed-lesson-section">
            ...
            <p>Computed merupakan sebuah properti dari vue yang berfungsi untuk menyimpan sebuah value ke dalam function
                pada
